...
func (m *LoginMessage) _validateHostname(host string) error {
...
func (m *LoginMessage) _validateEmail(addr string) error {
...
// Validate checks the field values on RefreshTokenMessage with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *RefreshTokenMessage) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on RefreshTokenMessage with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// RefreshTokenMessageMultiError, or nil if none found.
func (m *RefreshTokenMessage) ValidateAll() error {
	return m.validate(true)
}

func (m *RefreshTokenMessage) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return RefreshTokenMessageMultiError(errors)
	}

	return nil
}

// RefreshTokenMessageMultiError is an error wrapping multiple validation
// errors returned by RefreshTokenMessage.ValidateAll() if the designated
// constraints aren't met.
type RefreshTokenMessageMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m RefreshTokenMessageMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m RefreshTokenMessageMultiError) AllErrors() []error { return m }

// RefreshTokenMessageValidationError is the validation error returned by
// RefreshTokenMessage.Validate if the designated constraints aren't met.
type RefreshTokenMessageValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e RefreshTokenMessageValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e RefreshTokenMessageValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e RefreshTokenMessageValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e RefreshTokenMessageValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e RefreshTokenMessageValidationError) ErrorName() string {
	return "RefreshTokenMessageValidationError"
}

// Error satisfies the builtin error interface
func (e RefreshTokenMessageValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sRefreshTokenMessage.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = RefreshTokenMessageValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = RefreshTokenMessageValidationError{}
